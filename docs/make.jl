...
pages = OrderedDict(
    ...
    "How-To Guides" => Any[
        ...
        "Check Connectivity and Find Islands" => "how_to_guides/generated_connectivity.md",
    ],
    "Reference" => Any[
        "Matrix Overview and Indexing" => "reference/network_matrices_overview.md",
        "Matrix Types" => "reference/matrix_types.md",
        "Accessor Functions" => "reference/accessors.md",
        "Network Reduction" => "reference/network_reduction.md",
        "Aggregated Branches" => "reference/aggregated_branches.md",
